...
This repo comes with a `langflow.json` file. Create a project in [DataStax Langflow](https://langflow.datastax.com), and then import it from the Langflow UI.

![Import a project in Langflow](./docs/import.png)

From there, fill in any API keys required for Amazon Bedrock and such, and you should be able to run the flow. Finally, be sure to change the Langflow API endpoint to point to your instance in the [`Ai.tsx`](./app/Ai.tsx#L55) file.
